...
def dc_algorithm_cresci_2017(path, label):
    ...
    """
    antigen_array = []
    result = {"classified_count": 0, "classified_correctly_count": 0, "anomaly_classified_correctly_count": 0,
              "anomaly_classified_UNcorrectly_count": 0, "normal_classified_correctly_count": 0,
              "normal_classified_UNcorrectly_count": 0, "time": 0}
...
def dc_algorithm_cresci_2017_random_test(data1, label1, part1, data2, label2, part2):
    random.seed(10)
    start = time.time()
    load_dotenv()
    # =========================== INITIALIZE ANTIGENS ====================================
...
def dc_algorithm_twibot_2020_random_test(data, part):
    random.seed(10)
    start = time.time()
