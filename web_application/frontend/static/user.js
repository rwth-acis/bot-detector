...
$(document).ready(function(){
                ...
                for (var i = 0; i < results.length; i++) {
                    ...
                    div.innerHTML += '<div class="tweet-header">'
                       ...
                       + document.getElementById("name").innerHTML+'<span>'+document.getElementById("screen-name").innerHTML+'</span>  <span>  &#8226  '+results[i].created_at.replace(" +0000", "")+'</span></div></div>'
