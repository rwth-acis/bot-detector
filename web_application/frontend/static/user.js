...
$(document).ready(function(){
                ...
                for (var i = 0; i < results.length; i++) {
                    ...
                    div.innerHTML += '<div class="tweet-header">'
                       ...
                       + document.getElementById("name").innerHTML+'<span>'+document.getElementById("screen-name").innerHTML+'</span>  <span id="tweet-time">  &#8226  <a href="https://twitter.com/'+document.getElementById("screen-name-raw").innerHTML+'/status/'+results[i].id_str+'">'+results[i].created_at.replace(" +0000", "")+'</a></span></div></div>'
